    ...
    return Row(
      ...
      children: [
        _CategoryButton(
          ...
          selected: selectedCategory == PlaceCategory.natural,
          onCategoryChanged: onCategoryChanged,
        ),
        _CategoryButton(
          category: PlaceCategory.health,
          selected: selectedCategory == PlaceCategory.health,
          onCategoryChanged: onCategoryChanged,
        ),
        _CategoryButton(
          category: PlaceCategory.security,
          selected: selectedCategory == PlaceCategory.security,
          onCategoryChanged: onCategoryChanged,
        ),
      ],
    );
