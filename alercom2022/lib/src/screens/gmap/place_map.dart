  ...
  Future<void> _maybeUpdateMapConfiguration() async {
    ...
    if (_configuration != newConfiguration) {
      if (_configuration!.places == newConfiguration.places &&
        ...
        // If the configuration change is only a place change, just update
...
class _CategoryButtonBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const Color backgroundLightColor = Color.fromRGBO(54,54,54, 1);
          ...
          children: [
            ElevatedButton(
              style: ElevatedButton.styleFrom(
                  primary: selectedPlaceCategory == PlaceCategory.natural
                      ? backgroundColor
              ...
              onPressed: () => onChanged(PlaceCategory.natural),
            ),
            ElevatedButton(
              style: ElevatedButton.styleFrom(
                  primary: selectedPlaceCategory == PlaceCategory.health
                      ? backgroundColor
                      : backgroundLightColor),
              child: const Text(
                'Salud',
              ...
              onPressed: () => onChanged(PlaceCategory.health),
            ),
            ElevatedButton(
              style: ElevatedButton.styleFrom(
                  primary: selectedPlaceCategory == PlaceCategory.security
                      ? backgroundColor
                      : backgroundLightColor),
              child: const Text(
                'Seguridad',
              ...
              onPressed: () => onChanged(PlaceCategory.security),
            ),
          ],
        ),
      ),
        ...
        child: Column(
          children: [
            FloatingActionButton(
              ...
              child: const Icon(Icons.add_alert, size: 36.0, color: fontColor,),
            ),
            ...
            FloatingActionButton(
              ...
              mini: true,
              backgroundColor: backgroundColor,
              child: const Icon(Icons.layers, size: 28.0, color: fontColor,),
            ),
          ],
        ),
      ),
